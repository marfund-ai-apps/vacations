...
export default function TeamReport() {
    ...
    useEffect(() => {
        const fetchReports = async () => {
            ...
            try {
                ...
                toast.error("Error al cargar el reporte de tu equipo.");
            } finally {
                setLoading(false);
            }
        };
    ...
    }, [reportData, typeFilters, benefitFilter]);
    ...
    const handleExportCSV = () => {
        ...
        link.setAttribute("download", `reporte_equipo_${year}${month > 0 ? `_${MONTHS[month].label}` : ''}.csv`);
    ...
    return (
        <div className="px-4 sm:px-6 lg:px-8">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-semibold leading-6 text-gray-900">Reporte de Mi Equipo</h1>
                    <p className="mt-1 text-sm text-gray-700">
                        Resumen de días consumidos por tus colaboradores
